...
ActiveRecord::Schema[7.0].define(version: 2022_08_31_155850) do
  ...
  create_table "pick_list_items", force: :cascade do |t|
    t.bigint "pick_list_id", null: false
    t.bigint "item_id", null: false
    t.text "item_notes"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_pick_list_items_on_item_id"
  ...
  add_foreign_key "pick_list_items", "items"
